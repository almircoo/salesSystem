			...
			<div class="col-md-9">
				...
				<div class="mt-5 d-flex justify-content-between align-items-center flex-wrap gap-2">
                  ...
                  <div class="flex-shrink-0">
                        ...
                        <a href="cliente?opcion=editar" class="btn btn-secondary text-nowrap"> <i data-lucide="plus"></i> Agregar cliente</a>
                    </div>
                </div>
                <br>
                <%
												...
												<tr>
													...
													<td>
														<div class="d-flex justify-content-start">
															<a class="btn btn-sm btn-dark" href="cliente?opcion=editar&id=${c.clienteId }"> 
																<i data-lucide="square-pen"></i>
															</a> 
															<!-- Solo ADMIN puede eliminar clientes -->
															<c:if test="${usuario.rol=='ADMIN' }">
																<a class="btn btn-sm btn-danger" href="javascript:eliminar(${c.clienteId })">
